import { EmbedBuilder, Message, time, roleMention, Colors, inlineCode, TextChannel } from 'discord.js';

import { Client } from '@/structures';
import { ISpecialCommand, UserModel } from '@/models';
import { RoleLogFlags } from '@/enums';

async function roleHandler(client: Client, message: Message, command: ISpecialCommand, args: string[]) {
